...
router.post("/register", validInfo, async (req, res) => {
  try {
    ...
    if (newUser.rows.length > 0) {
      ...
      const newUser = await pool.query(
        "INSERT INTO users(username, password, email, registration_id, role, education, field_of_interest, time_of_registration, is_avatar_set) VALUES($1, $2, $3, $4, $5, $6, $7, $8, $9) RETURNING *",
        [username, hashedPassword, email, registration_id, role, education, field_of_interest, time, is_avatar_set]  
      );
